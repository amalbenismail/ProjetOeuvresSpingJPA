...
//	private static final Logger logger = LoggerFactory.getLogger(MultiControleur.class);
	...
	public ModelAndView modifierAdherent(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try {
			...
			AdherentEntity adherentAModifier;
			Service unService = new Service();
			adherentAModifier = unService.adherentById(id);
	...
	@RequestMapping(value = "submitModifierAdherent.htm")
	public ModelAndView submitModifierAdherent(HttpServletRequest request, HttpServletResponse response) throws Exception {
